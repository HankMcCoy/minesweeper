...
/***/ function(module, exports, __webpack_require__) {
	...
	var classNames = _interopRequire(__webpack_require__(26));

	var Immutable = _interopRequire(__webpack_require__(28));

	var React = _interopRequire(__webpack_require__(3));

	var _libBoardUtil = __webpack_require__(4);
	...
	var Board = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var rows = this.props.board.toArray().map(function (row, y) {
	      var cells = row.toArray().map(function (cell, x) {
	        return React.createElement(Cell, { cell: cell, key: x,
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  for (var x = 0; x < board.length; x++) {
	    ...
	    for (var y = 0; y < board[x].length; y++) {
	      board[x][y] = {
	        ...
	        isRevealed: false,
	        adjacentBombs: getAdjacencies(x, y).filter(function (neighX, neighY) {
	          return bombCoords.has(getKey(neighX, neighY));
	        }).length
	      };
	    }
	  }
	...
	function getRandomBombs(numRows, numCols, numBombs) {
	  ...
	  while (bombCoords.size < numBombs) bombCoords.add(getKey(getRandInt(numCols), getRandInt(numRows)));
	...
	function getAdjacencies(x, y) {
	  return [-1, 0, 1].map(function (dx) {
	    return [-1, 0, 1].filter(function (dy) {
	      return dx !== 0 || dy !== 0;
	    }).map(function (dy) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                = __webpack_require__(32)
	  , $def             = __webpack_require__(29)
	  , arrayMethod      = __webpack_require__(47)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $       = __webpack_require__(32)
	  ...
	  , $def    = __webpack_require__(29)
	  , assert  = __webpack_require__(35)
	  , forOf   = __webpack_require__(40).forOf
	  , SPECIES = __webpack_require__(38)('species')
	  , RECORD  = __webpack_require__(34).safe('record')
	  , PROMISE = 'Promise'
	  , global  = $.g
	  , process = global.process
	  , asap    = process && process.nextTick || __webpack_require__(44).set
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reflect = {
	  ...
	  apply: __webpack_require__(43)(Function.call, apply, 3),
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S, 'RegExp', {
	  ...
	  escape: __webpack_require__(41)(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setStatics(keys, length){
	  $.each.call($.a(keys), function(key){
	    if(key in [])statics[key] = __webpack_require__(43)(Function.call, [][key], length);
	  });
	}
